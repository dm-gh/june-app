...
- **Analysis · Extended**. Sections in order: Spent / Income cards; Per day (one bar per day of the period, today in accent, later days faded, a coral running-total line, the daily average in the heading); By category; Share of spending (donut in category colours with ink outlines and a legend with percentages); Income vs expense (coral and green paired bars per month over the trailing six months, net in the heading); Over time; By tag; By wallet; Wallets. Every section obeys the filters.
