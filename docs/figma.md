...
- **June Design System**: https://www.figma.com/design/XTJHO4UWcgl2auRItphKcR
  ...
  - Screens page (added 2026-09-12): three screen-level components, Nav bar (3), Transaction row (4), Sign toggle (2), plus the MVP screens as 390×844 phone frames: Sign in, Transactions, Add transaction (Expense and Income states), Add exchange, Analysis, Settings, Add wallet, Add category.
...
- Add category: emoji picker, name, auto-generated read-only slug with a warning that changing it breaks installed Shortcuts, colour chooser from the accent palette, live badge preview.
