...
- Transactions are editable and deletable in the app, including their date.
...
## Settings
Wallets (create, reorder, Init balance), Categories (name, slug), Default Currency, Capture Token (regenerate), Shortcut generation and download.
